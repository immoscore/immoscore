			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'user_type')
						@la_display($module, 'name_of_university')
						@la_display($module, 'parents')
						@la_display($module, 'scholarship')
						@la_display($module, 'savings')
						...
						@la_display($module, 'immoscore_guarantee')
					</div>
				</div>
			</div>
		</div>
