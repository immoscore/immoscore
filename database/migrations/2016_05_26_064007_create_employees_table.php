...
class CreateEmployeesTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Employees", 'employees', 'name', 'fa-group', [
            ...
            ["dept", "Department", "Dropdown", false, "0", 0, 256, false, "@departments"],
            ["city", "City", "String", false, "", 0, 50, false],
            ["address", "Address", "Address", false, "", 0, 1000, false],
            ["reporting_level_id", "Reporting Level", "Dropdown", false, "", 0, 0, false, "@reporting_levels"],
            ["country_id", "Country", "Dropdown", false, "", 0, 0, false, "@countries"],
            ["region_id", "Region", "Dropdown", false, "", 0, 0, false, "@regions"],
            ["woreda_id", "Woreda", "Dropdown", false, "0", 0, 0, true, "@woredas"],
            ["kebele_id", "Kebele", "Dropdown", false, "0", 0, 0, true, "@kebeles"],
        ]);
