...
class CreateUsersTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Users", 'users', 'name', 'fa-group', [
            ...
            ["designation", "Designation", "String", false, "", 0, 256, true],
            ...
            ["address", "Address", "String", false, "", 0, 1000, false],
            ["reporting_level_id", "Reporting Level", "Dropdown", false, "", 0, 0, true, "@reporting_levels"],
            ["country_id", "Country", "Dropdown", false, "", 0, 0, false, "@countries"],
            ["region_id", "Region", "Dropdown", false, "", 0, 0, false, "@regions"],
            ["woreda_id", "Woreda", "Dropdown", false, "0", 0, 0, false, "@woredas"],
            ["kebele_id", "Kebele", "Dropdown", false, "0", 0, 0, false, "@kebeles"],
            ["role_id", "User Role", "Dropdown", false, "", 0, 0, true, "@roles"],
        ]);
